...
const UI = {
    ...
    renderEmptyState(message = 'No records found') {
        return `
            <div class="flex flex-col items-center justify-center p-12 text-center fade-in text-gray-500">
    ...
    async renderDashboard() {
        if (!await Auth.hasPermission('view_dashboard')) {
            this.content.innerHTML = this.renderEmptyState(I18n.t('no_permission') || 'Access Denied');
            return;
        }
        try {
            this.clearContent();
